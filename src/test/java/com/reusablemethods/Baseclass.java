...
public class Baseclass {
	...
	public static WebDriver InitialiseSelenium(String url) {
		...
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\DELL\\eclipse-workspace\\saucedemo\\src\\test\\resources\\Driver\\chromedriver.exe");
	...
	// Code for read the data from Excel sheet
...
//Code for screenshot capturing
	public static void takeSnapShot() throws Exception {
		...
		File DestFile = new File(
				"C:\\Users\\DELL\\eclipse-workspace\\saucedemo\\src\\test\\resources\\Screenshot\\durga1"
						+ sdf.format(d) + ".png");
